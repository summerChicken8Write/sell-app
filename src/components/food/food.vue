		...
		<div class="food" v-show="showFood" ref="food">
			<div class="food-content">
				...
				<div class="info" v-show="food.info">
					...
					<p class="msg">{{food.info}}</p>
				</div>
				<split></split>
				<div class="rating">
					<h1 class="title">商品评价</h1>
					<ratingselect v-bind:selectType.sync="selectType" v-bind:onlyContent.sync="onlyContent" v-bind:desc="desc" v-bind:ratings="food.ratings"></ratingselect>
						...
						<ul v-show="food.ratings && food.ratings.length">
							<li class="rating-item border-1px" v-for="rating in food.ratings" v-show="needShow(rating.rateType, rating.text)">
								<div class="user">
									...
									<img v-bind:src="rating.avatar" alt="" class="avatar">
								</div>
